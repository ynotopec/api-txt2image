...
#intall
#${pythonVersion} -m pip install --upgrade pip setuptools wheel
#${pythonVersion} -m pip install -U torch torchvision --index-url https://download.pytorch.org/whl/cu124
# Use CUDA-compatible PyTorch for NVIDIA GPU
#${pythonVersion} -m pip install -U torch torchvision --index-url https://download.pytorch.org/whl/cu130
