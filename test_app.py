...
class Flux2PrequantizedCheckpointTests(unittest.TestCase):
    def test_rejects_distilled_9b_fp8_component_repository(self):
        original_values = (app.pipe, app.MODEL_ID, app.PIPELINE_CLASS)
        app.pipe = None
        ...
        try:
            ...
            app.pipe, app.MODEL_ID, app.PIPELINE_CLASS = original_values
